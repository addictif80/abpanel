    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="number" name="yearly_price" value="{{ old('yearly_price') }}" min="0" step="0.01"
        ...
        <p class="text-xs text-gray-400">Le(s) tarif(s) Stripe correspondants sont créés automatiquement à l'enregistrement (si une clé secrète Stripe est configurée dans les paramètres).</p>
    </div>
